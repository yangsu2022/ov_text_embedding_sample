...
class OVBgeEmbeddings(BaseModel, Embeddings):
    ...
    model_filename: str = Field("openvino_model_bs_1.xml", description="Filename of the OpenVINO model")
    ...
    def __init__(self, **kwargs: Any):
        ...
        core =ov.Core()
        model_path = Path(fp16_model_dir) / self.model_filename  # "openvino_model_int8_bs_1.xml"
    ...
    def encode(
        ...
        for start_index in trange(0, len(sentences), batch_size, desc="Batches", disable=not show_progress_bar):
            ...
            # print("OV model raw outputs:  ", out_features)
...
def convert_to_fp16(fp16_model_dir, model_name_or_path):
    ...
    inputs_info = [([-1, MAX_SEQ_LENGTH], ov.Type.i64)] * 3
...
def acc_check(model_name_or_path, fp16_model_dir, model_filename_input):
...
# fp16_model_dir = "bge-base-zh-v1.5"
# model_name_or_path = "BAAI/bge-base-zh-v1.5"

fp16_model_dir = "bge-small-zh-v1.5" 
...
print("--- reshape_fp16_batch_size")
batch_size = 1
isint8model = False
reshape_batch_size(fp16_model_dir, batch_size, isint8model)
acc_check(model_name_or_path, fp16_model_dir, "openvino_model_bs_1.xml") 
...
acc_check(model_name_or_path, fp16_model_dir, "openvino_model_int8_bs_1.xml")
